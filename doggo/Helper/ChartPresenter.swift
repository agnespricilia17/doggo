...
class ChartPresenter {
    ...
    func computeBarEntries(viewHeight: CGFloat) -> [ChartData] {
        ...
        for (index, entry) in dataEntries.enumerated() {
            ...
            let barEntry = ChartData(origin: CGPoint(x: xPosition, y: yPosition), barWidth: barWidth, barHeight: entryHeight, data: entry)
