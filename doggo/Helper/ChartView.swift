...
class ChartView: UIView {
    ...
    private let presenter = ChartPresenter(barWidth: 140, space: -70)
    
    private var animated: Bool = false
    
    private var barEntries: [ChartData] = [] {
        didSet {
    ...
    func updateDataEntries(dataEntries: [DogChartData], animated: Bool) {
    ...
    private func showEntry(index: Int, barEntry: ChartData, animated: Bool, oldEntry: ChartData?) {
